...
#[unsafe(no_mangle)]
pub unsafe extern "C-unwind" fn sol_checked_add_int_slow(a: i64, b: i64) -> i64 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C-unwind" fn sol_checked_sub_int_slow(a: i64, b: i64) -> i64 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C-unwind" fn sol_checked_mul_int_slow(a: i64, b: i64) -> i64 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C-unwind" fn sol_checked_div_int_slow(a: i64, b: i64) -> i64 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C-unwind" fn sol_checked_mod_int_slow(a: i64, b: i64) -> i64 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C-unwind" fn sol_checked_add_uint_slow(a: u64, b: u64) -> u64 {
    match a.checked_add(b) {
        Some(v) => v,
        None => throw_str("integer overflow in addition"),
    }
...
#[unsafe(no_mangle)]
pub unsafe extern "C-unwind" fn sol_checked_sub_uint_slow(a: u64, b: u64) -> u64 {
    match a.checked_sub(b) {
        Some(v) => v,
        None => throw_str("integer overflow in subtraction"),
    }
...
#[unsafe(no_mangle)]
pub unsafe extern "C-unwind" fn sol_checked_mul_uint_slow(a: u64, b: u64) -> u64 {
    match a.checked_mul(b) {
        Some(v) => v,
        None => throw_str("integer overflow in multiplication"),
    }
...
#[unsafe(no_mangle)]
pub unsafe extern "C-unwind" fn sol_checked_div_uint_slow(a: u64, b: u64) -> u64 {
    match a.checked_div(b) {
        Some(v) => v,
...
#[unsafe(no_mangle)]
pub unsafe extern "C-unwind" fn sol_checked_mod_uint_slow(a: u64, b: u64) -> u64 {
    match a.checked_rem(b) {
        Some(v) => v,
